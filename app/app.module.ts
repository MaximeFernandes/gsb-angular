...
import { MentionLegalComponent }  from './mentionlegal/app.mentionlegal.component';
...
@NgModule({
  ...
  declarations: [ AppComponent,ConnexionComponent,MedecinsComponent, VisitesComponent, MentionLegalComponent, NavbarComponent, ],
